              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                  <select name='os'>
                    ...
                    <option value='MacOS' {{ Request::input('os') == 'MacOS' ? 'selected' : '' }}>MacOS</option>
                    <option value='Linux' {{ Request::input('os') == 'Linux' ? 'selected' : '' }}>
                      Linux
                    </option>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 animate">
                        <div class="product-details">
                          ...
                          <p><strong><i class="fas fa-camera-retro"></i> Kích Thước: </strong>{{ $product->rear_camera }}</p>
